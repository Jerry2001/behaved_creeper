...
#Updates the creeper nbt data of ExplosionRadius if radius is altered
...
#Updates the creeper nbt data of Fuse if fuse_time is altered
...
#Updates the creeper nbt data of DeathLootTable if disc_flag is altered
